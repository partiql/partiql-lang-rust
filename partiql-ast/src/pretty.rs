...
impl PrettyDoc for Lit {
        ...
        A: Clone,
    {
        match self {
            ...
            Lit::EmbeddedDocLit(inner, typ) => inner.pretty_doc(arena), // TODO better pretty for embedded doc: https://github.com/partiql/partiql-lang-rust/issues/508
...
impl PrettyDoc for Type {
        ...
        A: Clone,
    {
        match self {
            ...
            Type::Integer2Type => arena.text("INT"),
            Type::Integer4Type => arena.text("INT"),
            Type::Integer8Type => arena.text("INT"),
