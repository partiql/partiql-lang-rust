...
/// Scalar implementation: Vector AND Vector (always dense output)
#[inline]
pub(crate) unsafe fn scalar_and_bool_vv(
    lhs: *const bool,
    rhs: *const bool,
    out: *mut bool,
    len: usize,
...
/// Scalar implementation: Vector AND Constant (always dense output)
#[inline]
pub(crate) unsafe fn scalar_and_bool_vc(
    vec: *const bool,
    constant: bool,
    out: *mut bool,
    len: usize,
...
/// Scalar implementation: Constant AND Vector (always dense output)
#[inline]
pub(crate) unsafe fn scalar_and_bool_cv(
    constant: bool,
    vec: *const bool,
    out: *mut bool,
    len: usize,
...
#[inline]
pub(crate) unsafe fn scalar_and_bool(
    lhs: ExecInput<bool>,
    rhs: ExecInput<bool>,
    out: *mut bool,
...
/// Boolean AND kernel
#[inline]
pub(crate) unsafe fn kernel_and_bool(
    lhs: ExecInput<bool>,
    rhs: ExecInput<bool>,
    out: &mut [bool],
    out_selection: Option<*const usize>,
    ...
    match (
        ...
        (false, false, false, false) => {
            ...
            scalar_and_bool_vv(lhs.data, rhs.data, out_ptr, len);
        }
        (false, true, false, _) => {
            // No input selections = write densely
            scalar_and_bool_vc(lhs.data, *rhs.data, out_ptr, len);
        }
        (true, false, _, false) => {
            // No input selections = write densely
            scalar_and_bool_cv(*lhs.data, rhs.data, out_ptr, len);
        }
        (true, true, _, _) => {
        ...
        _ => {
            ...
            scalar_and_bool(lhs, rhs, out_ptr, out_selection, len);
        }
    }
}
